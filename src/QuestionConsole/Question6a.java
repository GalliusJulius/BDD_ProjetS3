...
public class Question6a {
	...
	public static void repondreQuestion(Connection cnt) throws SQLException {
		...
		System.out.println("Tapez sur la touche entrée quand vous etes pret");
		...
		System.out.println("Tapez sur la touche entré pour continuer le test");
		sc.nextLine();
		...
		System.out.println("Tapez sur la touche entré pour commencer");
		sc.nextLine();
